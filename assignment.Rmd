...
First, I combine the values into a vector using the `c()` function, assign it to a variable named `r`, and print `r`


```{r vector}
r<-c(6.05, 4.89, 3.32, 4.93, 5.25, 5.04, 4.91, 2.84, 5.60, 5.34)
r
...
The standard error of the mean can be calculated by dividing the standard deviation by the square root of the sample size:0.3130568
```{r se}
h<-length(r)
h
sem<-sd(r)/sqrt(h)
